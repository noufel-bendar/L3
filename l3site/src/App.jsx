      ...
      case 'home':
        return (
          <div className="space-y-8">
            ...
            {/* Specialization Selection (Exams only) */}
            {selectedMode === 'exams' && !selectedSpecialization && (
              <div className="relative">
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50">
                  <h2 className="text-3xl font-bold text-white text-center mb-2">Choose Your Specialization</h2>
                  <p className="text-gray-400 text-center mb-8">Select your specialization to access exam materials</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {specializations.map((spec) => (
                      <button 
                        key={spec.id} 
            ...
            {/* Subject Selection (Exams only) */}
            {selectedMode === 'exams' && selectedSpecialization && !selectedSubject && (
              <div className="relative">
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50">
                  ...
                  <div className="mt-8 text-center">
                    <button 
                      ...
                      className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl hover:from-blue-500 hover:to-purple-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25 font-semibold"
                    >
              ...
              <div className="relative">
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50">
                  ...
                  <div className="mt-8 text-center">
                    <button 
                      onClick={() => setSelectedSemester(null)} 
                      className="bg-gradient-to-r from-red-600 to-pink-600 text-white px-8 py-4 rounded-xl hover:from-red-500 hover:to-pink-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-red-500/25 font-semibold"
                    >
                      ← Back to Semester Selection
                    </button>
                  </div>
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50">
                  <div className="mb-6">
                    <div className="flex items-center mb-4">
                      <div className="inline-block p-3 bg-gradient-to-r from-yellow-500 to-orange-600 rounded-xl mr-4 flex-shrink-0">
                        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-yellow-200 text-lg mt-1">
                          {selectedSpecialization.name} - {selectedSubject.name}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 text-center">
                    <button 
                      ...
                      className="bg-gradient-to-r from-yellow-600 to-orange-600 text-white px-8 py-4 rounded-xl hover:from-yellow-500 hover:to-orange-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-yellow-500/25 font-semibold"
                    >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {specializations.map((spec, index) => (
                      <button 
                        key={spec.id} 
                        onClick={() => setSelectedSpecialization(spec)} 
                        className={`group relative overflow-hidden bg-gradient-to-br ${spec.color} p-8 rounded-2xl shadow-2xl transition-all duration-300 transform hover:scale-105 border border-white/20 animate-fade-in-up hover:animate-pulse`}
